...
| `configs/punjab_ni138.json` | NEW | Batch config for all 23 Punjab districts, NI-138 (Act ID 732, Section 138), `fetch_pdfs: false`, `fetch_hearings: true`, disposed cases only, 8 workers. Uses `allowed_case_keys_path` to restrict to the sampled CNR list. |
